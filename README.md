...
If the `App` implementation lacks an initializer, add it. Place the following line inside:
...
[the sample app](https://github.com/software-mansion-labs/kmp-live-activity/tree/main/sample) for
more.
...
product—[hire&nbsp;us](https://swmansion.com/contact/projects?utm_source=kmp-live-activity&utm_medium=readme).
